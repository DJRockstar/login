<%
	if(session.getAttribute("name")==null){ //JSP provide some objects implicitly thats why we don't need session obj
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1 bg-danger"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="index.jsp#page-top"> Hi! <%=session.getAttribute("name")%></a></li>
